...
here()
# Output from here():
# [1] "C:/Users/Sarah/Dropbox/@WP2/miRNA_seqLibraykit/miSeq_Bioinformatics/R_scripts/Project2_QIAseq"
...
# Select counts only
annotCounts %>%
  dplyr::select(starts_with("QIA")) -> counts
...
annotCounts %>%
  dplyr::select(-starts_with("QIA")) -> gene_annot
