...
here()
# Output from here():
# [1] "C:/Users/Sarah/Dropbox/@WP2/miRNA_seqLibraykit/miSeq_Bioinformatics/R_scripts/Project1_NEXTflex"
...
# Select counts only
annotCounts %>%
  dplyr::select(starts_with("NEXT")) -> counts
...
annotCounts %>%
  dplyr::select(-starts_with("NEXT")) -> gene_annot
